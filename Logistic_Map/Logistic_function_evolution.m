clear;close all;clc
alpha=4;n=1000;part=200;p=12;percent=10;
rate=[0.5;0.5];
lamda=1;
f=@(x)alpha.*x.*(1-x);
...
for i=1:4
    ...
    hold on
    plot(0:1/part:1,1200,'r*')
    %xlim([0,1])
end
suptitle(['n=',num2str(n),'; part=',num2str(part),'; p=',num2str(p)])
saveas(hh,['.\Logistic_function_evolution\','n',num2str(n),'part',num2str(part),'percent',num2str(percent),'%p',num2str(p),'.png'])
